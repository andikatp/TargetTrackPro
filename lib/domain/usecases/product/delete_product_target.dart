...
class DeleteProductTarget implements UseCaseWithParams<void, Target> {
  DeleteProductTarget({required ProductRepository repository})
      : _repository = repository;
  final ProductRepository _repository;

  @override
  ResultFuture<void> call(Target params) =>
      _repository.deleteProductTarget(params);
}
